...
public class JPAClassGenerator {
	 ...
	 *
	 * @param classSourceModelUtils
	 *            An access to the class source model utils.
	 * @param nameConverter
	 *            An access to the name converter of the application.
	 * @param typeConverter
	 *            An access to the type converter of the application.
	 */
	public JPAClassGenerator(ClassSourceModelUtils classSourceModelUtils,
			NameConverter nameConverter, TypeConverter typeConverter) {
		super();
