...
/**
 * A generator for result page service objects.
 *
 * @author ollie
 *
 */
public class ResultPageSOClassGenerator {

	private static final Logger LOG = Logger.getLogger(ResultPageSOClassGenerator.class);

	private final ClassSourceModelUtils classSourceModelUtils;
	private final NameConverter nameConverter;
	private final TypeConverter typeConverter;

	public ResultPageSOClassGenerator(ClassSourceModelUtils classSourceModelUtils, NameConverter nameConverter,
	...
	public ClassSourceModel generate(String authorName) {
		ClassSourceModel csm = this.classSourceModelUtils.createResultPageSOClassSourceModel();
		csm.setPackageModel(new PackageSourceModel().setPackageName(
				"${base.package.name}." + this.classSourceModelUtils.createResultPageSOClassPackageNameSuffix()));
